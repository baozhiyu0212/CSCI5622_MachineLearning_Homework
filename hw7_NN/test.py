...
class TestNN(unittest.TestCase):
    def testBackPropNoReg(self):
        # ===================================================== 
        # BackProp test without regularization  
        # ===================================================== 
        nn_noreg = Network([2,3,2])
        nn_noreg.SGD_train(train, epochs=5, eta=0.25, lam=0.0, verbose=False)
    ...
    def testBackPropReg(self):
        # ===================================================== 
        # BackProp test with regularization  
        # ===================================================== 
        nn_reg = Network([2,3,2])
        nn_reg.SGD_train(train, epochs=5, eta=0.25, lam=0.2, verbose=False)
    ...
    def testGradientCheck(self):
        # ===================================================== 
        # Gradient Checking Test 
        # ===================================================== 
        nn_gc = Network([2,3,2])
        nn_gc.SGD_train(train, epochs=5, eta=0.25, lam=0.0, verbose=False)
        rel_errs = nn_gc.gradient_checking(train)
        for re in rel_errs:
